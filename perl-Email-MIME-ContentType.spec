...
Ten moduł odpowiada za przetwarzanie nagłówków listów dotyczących
rodzaju zawartości zgodnie z rozdziałem 5.1 RFC 2045. Zwraca hasza
z wpisami dla typu dyskretnego, typu złożonego i hasza atrybutów.
